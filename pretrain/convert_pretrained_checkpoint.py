# This file is borrowed from https://github.com/Lightning-AI/litgpt/blob/main/litgpt/scripts/convert_pretrained_checkpoint.py
# with a minor change to load full_checkpoint["state_dict"] instead of full_checkpoint["model"] on line 47 
# due to a bug in the original file
...
def convert_pretrained_checkpoint(checkpoint_dir: Path, output_dir: Path) -> None:
    ...
    with incremental_save(output_checkpoint_file) as saver:
        ...
        loaded_state_dict = full_checkpoint["state_dict"]
